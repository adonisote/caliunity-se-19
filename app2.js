...
app.post('/contact', (req, res) => {
  ...
  res.send(
    `Thank you for message. We will be in touch soon. This is your message:"${req.body.user_message}" `
  );
  // res.sendFile("public/pages/contact.html", {root: __dirname})
});
...
app.get('/advice', (req, res) => {
  ...
  res.send(
    `You searched for: "${searchAdvice}". We are looking in our database. We will get back to you soon...`
  );
});
...
const users = [
  {
    ...
    posts: [
      {
        postId: 1,
        title: 'How to master motivation',
        message: 'I want to go more often....',
      },
    ],
  },
